...
<template>
  <AuthGuard>
    <div class="relative flex">
      <aside
        :class="[
          'absolute inset-y-0 z-20 flex h-dvh w-full flex-shrink-0 flex-grow-0 flex-col bg-white  transition-all sm:sticky sm:start-0 sm:w-72 sm:border-r ',
